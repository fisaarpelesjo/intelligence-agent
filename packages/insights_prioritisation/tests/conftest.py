...
#: This package first, then the uninstalled sibling it consumes.
SOURCE_ROOTS = (
    PACKAGE_ROOT / "src",
    PACKAGES / "anomaly_investigation" / "src",
    #: `011`'s package, uninstalled for the same reason as the two above: installing would modify
    #: the interpreter the running bot uses. The importability node reaches it through this root.
    PACKAGES / "conversation_context" / "src",
)
