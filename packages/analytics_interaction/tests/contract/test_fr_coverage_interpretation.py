"""FR coverage: interpretation, periods, the model port, intent and requests — T170.

    Evidence: each FR in scope resolves to a module **and** a passing executable
    validation. — `tasks.md` T170
...
An FR belongs to this domain when a `src/interpretation/` or `src/execution/`
module cites it, or when `interpretation-contract.md` does.
